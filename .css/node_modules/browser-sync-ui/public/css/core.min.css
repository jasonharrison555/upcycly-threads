...
[bs-link~=version]:focus, [bs-link~=version]:hover {
  color: #f54747;
}
...
@media only screen and (min-width: 600px) {
  ...
  [bs-sidebar]:after {
    ...
    background: linear-gradient(90deg, transparent 0, rgba(0, 0, 0, 0.2));
  }
}
[bs-section-nav] {
  background: #444;
...
[bs-button]:focus, [bs-button]:hover {
  text-decoration: none;
  color: #fff;
}
...
[bs-button~=subtle]:focus, [bs-button~=subtle]:hover {
  color: #f54747;
  background: #f0f0f0;
}
...
[bs-button~=subtle-alt]:focus, [bs-button~=subtle-alt]:hover {
  color: #8a8a8a;
  background: #f0f0f0;
}
...
@media only screen and (min-width: 600px) {
  [bs-action~=menu-close], [bs-action~=menu-toggle] {
    display: none;
  }
}
button, input, select {
...
.loader, .loader:after, .loader:before {
  background: #333;
  -webkit-animation: b 0.5s infinite ease-in-out;
  animation: b 0.5s infinite ease-in-out;
  width: 1em;
  height: 2em;
}
...
@media only screen and (min-width: 600px) {
  ...
  [bs-panel-content] [bs-panel-icon] [bs-svg-icon], [bs-panel-content] [bs-panel-icon] [bs-svg-icon] use {
    height: 30px;
    width: 30px;
  }
}
...
[bs-state-wrapper].success [bs-state~=success], [bs-state-wrapper].waiting [bs-state~=waiting] {
  opacity: 1;
}
...
[bs-footer] a:focus, [bs-footer] a:hover {
  text-decoration: none;
  color: #c5c5c5;
}
...
pre {
  ...
  padding: 14px;
  border-radius: 3px;
  box-shadow: inset -10px 0 10px #f0f0f0;
